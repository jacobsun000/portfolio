...
import { FaJava, FaPython, FaReact, FaRust, FaUnity } from 'react-icons/fa';
import { SiCplusplus, SiNvidia, SiOpengl, SiPostgresql, SiQt, SiSpringboot, SiTailwindcss, SiVim, SiPytorch } from 'react-icons/si';
